// Dafny program avl.dfy compiled into C#
...
// Command-line arguments: run avl.dfy
// avl.dfy

method TestAVLNode()
{
  var root := new AVLNode<int>(10);
  var leftChild := new AVLNode<int>(5);
  var rightChild := new AVLNode<int>(15);
  root.left := leftChild;
...
{
  var root := new AVLNode<int>(20);
  var left := new AVLNode<int>(10);
  var leftLeft := new AVLNode<int>(5);
  left.left := leftLeft;
  left.UpdateHeight();
  root.left := left;
  root.UpdateHeight();
  var right := new AVLNode<int>(30);
  var rightRight := new AVLNode<int>(35);
...
class AVLTree<T> {
    ...
    decreases *
  {
    if root == null {
      ...
      var _ /* _v0 */ := root.Insert(value, cmp);
    }
  }
  ...
  {
    if root != null {
      assume {:axiom} root.ValidAVLNode();
      root := root.Delete(value, cmp);
      assume {:axiom} this.Valid();
    }
  }
}
")]
...
namespace _module {
  ...
  public partial class __default {
    public static void TestAVLNode()
    {
      AVLNode<BigInteger> _0_root;
      AVLNode<BigInteger> _nw0 = new AVLNode<BigInteger>();
      _nw0.__ctor(new BigInteger(10));
      _0_root = _nw0;
      AVLNode<BigInteger> _1_leftChild;
      AVLNode<BigInteger> _nw1 = new AVLNode<BigInteger>();
      _nw1.__ctor(new BigInteger(5));
      _1_leftChild = _nw1;
      AVLNode<BigInteger> _2_rightChild;
      AVLNode<BigInteger> _nw2 = new AVLNode<BigInteger>();
      _nw2.__ctor(new BigInteger(15));
      _2_rightChild = _nw2;
      (_0_root).left = _1_leftChild;
      (_0_root).right = _2_rightChild;
      (_0_root).UpdateHeight();
    }
    public static void TestBalanceFactors()
    {
      AVLNode<BigInteger> _0_root;
      AVLNode<BigInteger> _nw0 = new AVLNode<BigInteger>();
      _nw0.__ctor(new BigInteger(20));
      _0_root = _nw0;
      AVLNode<BigInteger> _1_left;
      AVLNode<BigInteger> _nw1 = new AVLNode<BigInteger>();
      _nw1.__ctor(new BigInteger(10));
      _1_left = _nw1;
      AVLNode<BigInteger> _2_leftLeft;
      AVLNode<BigInteger> _nw2 = new AVLNode<BigInteger>();
      _nw2.__ctor(new BigInteger(5));
      _2_leftLeft = _nw2;
      (_1_left).left = _2_leftLeft;
      (_1_left).UpdateHeight();
      (_0_root).left = _1_left;
      (_0_root).UpdateHeight();
      AVLNode<BigInteger> _3_right;
      AVLNode<BigInteger> _nw3 = new AVLNode<BigInteger>();
      _nw3.__ctor(new BigInteger(30));
      _3_right = _nw3;
      AVLNode<BigInteger> _4_rightRight;
      AVLNode<BigInteger> _nw4 = new AVLNode<BigInteger>();
      _nw4.__ctor(new BigInteger(35));
      _4_rightRight = _nw4;
      (_3_right).right = _4_rightRight;
      (_3_right).UpdateHeight();
      (_0_root).right = _3_right;
      (_0_root).UpdateHeight();
    }
    public static void TestSingleNode()
    {
      AVLNode<BigInteger> _0_node;
      AVLNode<BigInteger> _nw0 = new AVLNode<BigInteger>();
      _nw0.__ctor(new BigInteger(42));
      _0_node = _nw0;
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      __default.TestAVLNode();
      __default.TestBalanceFactors();
      __default.TestSingleNode();
    }
  }

  public partial class AVLNode<T> {
    public AVLNode() {
      this.data = default(T);
      this.left = ((AVLNode<T>)null);
      this.right = ((AVLNode<T>)null);
    ...
    public void __ctor(T @value)
    {
      ...
      (this).left = (AVLNode<T>)null;
      (this).right = (AVLNode<T>)null;
      (this).height = BigInteger.One;
    }
    public BigInteger Height() {
      return this.height;
    }
    public BigInteger LeftHeight() {
      if ((this.left) == (object) ((AVLNode<T>)null)) {
        return BigInteger.Zero;
      } else {
        return this.left.height;
      }
    }
    public BigInteger RightHeight() {
      if ((this.right) == (object) ((AVLNode<T>)null)) {
        return BigInteger.Zero;
      } else {
        return this.right.height;
      }
    }
    public BigInteger BalanceFactor() {
      return ((this).RightHeight()) - ((this).LeftHeight());
    }
    public bool IsBalanced() {
      BigInteger _0_bf = (this).BalanceFactor();
      return ((new BigInteger(-1)) <= (_0_bf)) && ((_0_bf) <= (BigInteger.One));
    }
    public bool HeightValid() {
      return (this.height) == ((BigInteger.One) + (((((this).LeftHeight()) > ((this).RightHeight())) ? ((this).LeftHeight()) : ((this).RightHeight()))));
    }
    public bool ValidAVLNode() {
      return ((((this).HeightValid()) && ((this).IsBalanced())) && (((this.left) == (object) ((AVLNode<T>)null)) || ((this.left).ValidAVLNode()))) && (((this.right) == (object) ((AVLNode<T>)null)) || ((this.right).ValidAVLNode()));
    }
    public void UpdateHeight()
    {
      BigInteger _0_leftH;
      _0_leftH = (this).LeftHeight();
      BigInteger _1_rightH;
      _1_rightH = (this).RightHeight();
      BigInteger _2_maxH;
      if ((_0_leftH) > (_1_rightH)) {
        _2_maxH = _0_leftH;
      } else {
        _2_maxH = _1_rightH;
      }
      (this).height = (BigInteger.One) + (_2_maxH);
    }
    public AVLNode<T> LeftRotate()
    {
      AVLNode<T> newRoot = default(AVLNode<T>);
      AVLNode<T> _0_pivot;
      _0_pivot = this.right;
      AVLNode<T> _1_temp;
      _1_temp = _0_pivot.left;
      (_0_pivot).left = this;
      (this).right = _1_temp;
      (this).UpdateHeight();
      (_0_pivot).UpdateHeight();
      newRoot = _0_pivot;
      return newRoot;
    }
    ...
    public AVLNode<T> LeftRightRotate()
    {
      AVLNode<T> newRoot = default(AVLNode<T>);
      AVLNode<T> _0_a;
      _0_a = this;
    ...
    public AVLNode<T> RightLeftRotate()
    {
      AVLNode<T> newRoot = default(AVLNode<T>);
      AVLNode<T> _0_a;
      _0_a = this;
    ...
    public bool IsLeaf() {
      return ((this.left) == (object) ((AVLNode<T>)null)) && ((this.right) == (object) ((AVLNode<T>)null));
    }
    public bool HasOneChild() {
      return (((this.left) == (object) ((AVLNode<T>)null)) && ((this.right) != (object) ((AVLNode<T>)null))) || (((this.left) != (object) ((AVLNode<T>)null)) && ((this.right) == (object) ((AVLNode<T>)null)));
    }
    public bool HasTwoChildren() {
      return ((this.left) != (object) ((AVLNode<T>)null)) && ((this.right) != (object) ((AVLNode<T>)null));
    }
    public AVLNode<T> Insert(T @value, Comparator<T> cmp)
    {
      AVLNode<T> newRoot = default(AVLNode<T>);
      bool _0_isEqual;
      bool _out0;
      _out0 = (cmp).Equal(this.data, @value);
      _0_isEqual = _out0;
      if (_0_isEqual) {
        newRoot = this;
        return newRoot;
      ...
      bool _1_isLess;
      bool _out1;
      _out1 = (cmp).Less(@value, this.data);
      _1_isLess = _out1;
      if (_1_isLess) {
        if ((this.left) == (object) ((AVLNode<T>)null)) {
          AVLNode<T> _nw0 = new AVLNode<T>();
          _nw0.__ctor(@value);
          (this).left = _nw0;
        }
      } else {
        if ((this.right) == (object) ((AVLNode<T>)null)) {
          AVLNode<T> _nw1 = new AVLNode<T>();
          _nw1.__ctor(@value);
          (this).right = _nw1;
        }
      }
    ...
    public AVLNode<T> FindMinNode()
    {
      AVLNode<T> minNode = default(AVLNode<T>);
      AVLNode<T> _0_current;
      _0_current = this;
      while ((_0_current.left) != (object) ((AVLNode<T>)null)) {
        _0_current = _0_current.left;
      }
      minNode = _0_current;
      return minNode;
    }
    public AVLNode<T> Rebalance()
    {
      AVLNode<T> newRoot = default(AVLNode<T>);
      newRoot = this;
      return newRoot;
    }
    public AVLNode<T> Delete(T @value, Comparator<T> cmp)
    {
      AVLNode<T> newRoot = ((AVLNode<T>)null);
      bool _0_isEqual;
      bool _out0;
      _out0 = (cmp).Equal(this.data, @value);
      _0_isEqual = _out0;
  ...
  public class _Companion_Comparator<T> {
  }

  public partial class AVLTree<T> {
    public AVLTree() {
      this.root = ((AVLNode<T>)null);
      this.cmp = default(Comparator<T>);
    }
    public AVLNode<T> root {get; set;}
    public Comparator<T> cmp {get; set;}
    public void __ctor(Comparator<T> c)
    {
      (this).root = (AVLNode<T>)null;
      (this).cmp = c;
    }
    public bool Valid() {
      return ((this.root) == (object) ((AVLNode<T>)null)) || ((this.root).ValidAVLNode());
    }
    public bool IsEmpty()
    {
      bool empty = false;
      empty = (this.root) == (object) ((AVLNode<T>)null);
      return empty;
    }
    public BigInteger GetHeight()
    {
      BigInteger h = BigInteger.Zero;
      if ((this.root) == (object) ((AVLNode<T>)null)) {
        h = BigInteger.Zero;
      } else {
        h = this.root.height;
      }
    ...
    public bool Search(T @value)
    {
      bool found = false;
      AVLNode<T> _0_current;
      _0_current = this.root;
      while ((_0_current) != (object) ((AVLNode<T>)null)) {
        bool _1_isEqual;
        bool _out0;
        _out0 = (this.cmp).Equal(_0_current.data, @value);
        _1_isEqual = _out0;
        if (_1_isEqual) {
          found = true;
          return found;
        ...
        bool _2_isLess;
        bool _out1;
        _out1 = (this.cmp).Less(@value, _0_current.data);
        _2_isLess = _out1;
        if (_2_isLess) {
          _0_current = _0_current.left;
        } else {
          _0_current = _0_current.right;
        }
      }
      found = false;
      return found;
    ...
    public void Insert(T @value)
    {
      if ((this.root) == (object) ((AVLNode<T>)null)) {
        ...
        AVLNode<T> _0___v0;
        AVLNode<T> _out0;
        _out0 = (this.root).Insert(@value, this.cmp);
        _0___v0 = _out0;
      }
    }
    public void Delete(T @value)
    {
      if ((this.root) != (object) ((AVLNode<T>)null)) {
        AVLNode<T> _out0;
        _out0 = (this.root).Delete(@value, this.cmp);
        (this).root = _out0;
      }
    }
  }
