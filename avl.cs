...
namespace _module {
  ...
  public partial class __default {
    public static void TestAVLNode()
    {
      ...
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("AVL Node test passed! Root node has value: ")).ToVerbatimString(false));
      Dafny.Helpers.Print((_0_root.data));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Root height: ")).ToVerbatimString(false));
      Dafny.Helpers.Print(((_0_root).Height()));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Balance factor: ")).ToVerbatimString(false));
      Dafny.Helpers.Print(((_0_root).BalanceFactor()));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("Is balanced: ")).ToVerbatimString(false));
      Dafny.Helpers.Print(((_0_root).IsBalanced()));
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("\n")).ToVerbatimString(false));
    }
    public static void _Main(Dafny.ISequence<Dafny.ISequence<Dafny.Rune>> __noArgsParameter)
    {
      __default.TestAVLNode();
      Dafny.Helpers.Print((Dafny.Sequence<Dafny.Rune>.UnicodeFromString("All tests completed successfully!\n")).ToVerbatimString(false));
    }
  }
  ...
  public partial class AVLNode<T> {
    ...
    public bool ValidAVLNode() {
      return ((this).HeightValid()) && ((this).IsBalanced());
    }
    public void UpdateHeight()
    {
      ...
      (this).height = (BigInteger.One) + ((((_0_leftH) > (_1_rightH)) ? (_0_leftH) : (_1_rightH)));
    }
    public bool IsLeaf() {
